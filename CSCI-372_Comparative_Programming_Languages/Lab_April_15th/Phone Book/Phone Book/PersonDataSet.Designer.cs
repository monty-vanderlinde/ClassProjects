...
namespace Phone_Book {
    ...
    public partial class PersonDataSet : global::System.Data.DataSet {
        ...
        public partial class PhoneDataTable : global::System.Data.TypedTableBase<PhoneRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PhoneRow AddPhoneRow(string Name, string Phone) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PhoneRow FindByPersonID(int PersonID) {
...
namespace Phone_Book.PersonDataSetTableAdapters {
    ...
    public partial class PhoneTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Phone] WHERE (([PersonID] = @Original_PersonID) AND ([Name] = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Phone] ([Name], [Phone]) VALUES (@Name, @Phone);\r\nSELECT Perso" +
                "nID, Name, Phone FROM Phone WHERE (PersonID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Phone] SET [Name] = @Name, [Phone] = @Phone WHERE (([PersonID] = @O" +
                "riginal_PersonID) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone))" +
                ";\r\nSELECT PersonID, Name, Phone FROM Phone WHERE (PersonID = @PersonID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, Name, Phone FROM dbo.Phone";
        ...
        public virtual int Fill(PersonDataSet.PhoneDataTable dataTable) {
        ...
        public virtual PersonDataSet.PhoneDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PersonDataSet.PhoneDataTable dataTable = new PersonDataSet.PhoneDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PersonDataSet.PhoneDataTable dataTable) {
